...
public class OutrasDuvidas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outras_duvidas);

        botaoVoltar = findViewById(R.id.btnOutrasDuvidas);
        btnFazerPergunta = findViewById(R.id.btnFazerPerguntaOutras);
        editPergunta = findViewById(R.id.editPerguntaOutrasDuvidas);
        ...
        botaoVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(OutrasDuvidas.this, OpcoesActivity.class);
        ...
        btnFazerPergunta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                apiService.fazerRequisicao(pergunta, progressDialog, response -> {
                    Intent intent = new Intent(OutrasDuvidas.this, RespostaActivity.class);
                    intent.putExtra("pergunta", pergunta);
                    intent.putExtra("resposta", response);
                    startActivity(intent);
                }, errorMessage -> {
                    Toast.makeText(OutrasDuvidas.this, errorMessage, Toast.LENGTH_LONG).show();
                });
            }
        });
    }
