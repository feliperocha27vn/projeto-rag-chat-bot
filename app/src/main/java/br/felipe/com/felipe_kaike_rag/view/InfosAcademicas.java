...
public class InfosAcademicas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_infos_academicas);

        botaoVoltar = findViewById(R.id.btnVoltarInfosAcademicas);
        btnFazerPergunta = findViewById(R.id.btnEnviarPerguntaInfosAcademica);
        editPergunta = findViewById(R.id.editPerguntaInfosAcademicas);
        ...
        botaoVoltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(InfosAcademicas.this, OpcoesActivity.class);
        ...
        btnFazerPergunta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                apiService.fazerRequisicao(pergunta, progressDialog, response -> {
                    Intent intent = new Intent(InfosAcademicas.this, RespostaActivity.class);
                    intent.putExtra("pergunta", pergunta);
                    intent.putExtra("resposta", response);
                    startActivity(intent);
                }, errorMessage -> {
                    Toast.makeText(InfosAcademicas.this, errorMessage, Toast.LENGTH_LONG).show();
                });
            }
        });
    }
